...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/28 20:47:48 by wprintes          #+#    #+#             */
/*   Updated: 2023/10/28 21:31:36 by wprintes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void BitcoinExchange::openDb(void)
{
    std::string line;
...
void BitcoinExchange::OpenInput(std::string path)
{
    std::string line;
...
void BitcoinExchange::split(std::string str, const char delimiter, std::map<std::string, double> &result)
{
    std::string key;
    std::string value;
...
bool BitcoinExchange::validDate(std::map<std::string, std::string> data)
{
...
void BitcoinExchange::findDate(std::string date, std::map<std::string, double> data, double value)
{
...
void BitcoinExchange::showBtc(std::map<std::string, double> data, std::string str)
{
    size_t i = str.find('|');
    std::string key;
    std::string value;
